<?php 
    ...
    $sql = "SELECT 
        ...
        WHERE  visibility = 'Show' AND show_unit = 'Yes'
	...
	<div class="full-width page-head color-secondary-orange-dk-2">
		<div class="row">
			<div class="twelve columns">
					<h3>The 2014 Fort Worth RV Show</h3>
			</div>
		</div>
	</div>
		    	...
		    	<table class="striped">
		    		...
		    		<tbody>
		    			...
		    			<tr>
		    				...
		    				<td><?php echo $row['year']; ?> <?php echo $row['make']; ?> <?php echo $row['model']; ?> <?php echo $row['model_num']; ?></td>
		    				<td><?php echo $row['uvw']; ?></td>
		    				<td><?php echo $row['unit_length_ft']; ?>' <?php echo $row['unit_length_in']; ?>"</td>
                            <td> <?php echo money_format('%.0n', $row['msrp']);?></td>
                            <td>
                            	 <?php 
									 
									 $discount = $row['msrp'] - $row['show_price'];
									 echo money_format('%.0n', $discount);
                            	
                            	?>
                        	</td>
                            <td> <?php echo money_format('%.0n', $row['show_price']);?></td>
		    			</tr>
