<?php 
	...
	if (isset($_POST['send'])) {
	    ...
	    $expected = array('trade_type', 'trade_year', 'trade_make', 'trade_model', 'trade_model_num', 'trade_slides', 'trade_generator', 'trade_generator', 'trade_gen_size', 'trade_gen_hrs', 'trade_ac', 'trade_ext', 'trade_patio_awning', 'trade_win_awning', 'trade_slide_awning', 'trade_inverter', 'trade_refer', 'trade_surround', 'trade_DVD', 'trade_dualpane', 'trade_combo_washer_dryer', 'trade_stack_washer_dryer','trade_shades', 'trade_living_tv', 'trade_bedroom_tv', 'trade_ext_tv', 'trade_con_carpet', 'trade_con_sofa', 'trade_con_dinette', 'trade_con_cabinets', 'trade_con_refer', 'trade_con_oven', 'trade_con_bed_spread','trade_con_decals', 'trade_con_paint', 'trade_windshield_damage', 'trade_missing', 'trade_ext_damage', 'trade_int_damage', 'trade_window_damage', 'trade_water_damage', 'trade_wall_delamination', 'trade_everything_working', 'trade_everything_original', 'trade_org_owner', 'trade_smoked', 'trade_lived_in', 'trade_pets', 'trade_manuals',  'trade_bed_spread', 'trade_remotes', 'trade_org_tires', 'trade_tires_match', 'trade_tires_rotted', 'trade_tires_wearing', 'trade_ac_condition', 'trade_further_info', 'trade_owe', 'trade_amount_owed', 'trade_bid', 'trade_interest', 'trade_first_name', 'trade_last_name', 'trade_phone', 'salesman', 'subscribe', 'email' );
		...
		<div class="full-width">
	   		<div class="row">
	        	<div class="twelve columns page-content">
	        		...
	        		<form class="trade-form" id="trade_form" name="trade_form" method="post" action="coach-evaluation-tt.php">
										...
										<div class="two columns field  <?php if ($missing && in_array('trade_type', $missing)) { ?> danger <?php } ?>">
											<div class="picker">
												<select id="trade_type" name="trade_type">
													...
													<option value="Tent Camper" <?php if ($_POST && $_POST['trade_type'] == 'Tent Camper' && !$mailsent) echo "selected"; ?>>Tent Camper</option>
													<option value="Travel Trailer" <?php if ($_POST && $_POST['trade_type'] == 'Travel Trailer' && !$mailsent) echo "selected"; ?>>Travel Trailer</option>
													<option value="Fifth Wheel" <?php if ($_POST && $_POST['trade_type'] == 'Fifth Wheel' && !$mailsent) echo "selected"; ?>>Fifth Wheel</option>
													<option value="Toy Hauler" <?php if ($_POST && $_POST['trade_type'] == 'Toy Hauler' && !$mailsent) echo "selected"; ?>>Toy Hauler</option>
												</select>
											</div>
										</div>
										
										<div class="two columns field  <?php if ($missing && in_array('trade_year', $missing)) { ?> danger <?php } ?>">
											<input class=" text input"  type="text" name="trade_year" id="trade_year" placeholder="Trade Year" <?php if ($missing || $errors) { echo 'value="' . htmlentities($_POST['trade_year'], ENT_COMPAT, 'UTF-8') . '"'; } ?>>
										</div>
										...
										<div class="three columns field">
											<div class="picker">
												<select id="trade_ac_condition" name="trade_ac_condition">
													<option value="Did Not Answer" disabled <?php if (!$_POST) echo "selected"; ?>>A/C's cold?</option>
