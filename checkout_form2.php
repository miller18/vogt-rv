	...
	<div class="full-width page-head color-secondary-orange-dk-2">
		<div class="row">
				<div class="twelve columns">
					<h3>Reserve your new RV</h3>
			    <h2>Vogt RV's Online Reservation</h2>
				</div>
			</div>
		</div>
		...
		<div class="full-width">
	   		<div class="row">
	        	<div class="twelve columns page-content">
					...
					$relay_response_url = "https://vogtrv.com/relay_response.php";
					$api_login_id = '9kG342WgKaF';
					//$api_login_id = '8nrG39EH'; //test
					$transaction_key = '9De65r9s5wU553Mj';
					//$transaction_key = '4k3wRkSR4J499e54'; //test
					$amount = $_GET['charge_amount'];
					$charge_reason = $_GET['charge_reason'];
					$stock_num = $_GET['stock_num'];
					$fp_sequence = "123"; // Any sequential number like an invoice number.
					echo AuthorizeNetDPM::getCreditCardForm($amount, $charge_reason, $stock_num, $email, $fp_sequence, $relay_response_url,$api_login_id, $transaction_key);?>
