<?php 
    ...
    $pic_location = $_GET['location'];
    $pic_usage = $_GET['condition'];

    if ($pic_usage == 'both') {
    	$qry_string = "AND vrvInventory.location = '" . $pic_location . "'";
    } elseif ($pic_location == 'both') {
    	$qry_string = ""; //"vrvInventory.unit_condition = '" . $pic_usage . "'";
    } else {
    	$qry_string = "AND vrvInventory.unit_condition = '" . $pic_usage . "' AND vrvInventory.location = '" . $pic_location . "'";
    }
    ...
    $sql = "SELECT 
        ...
        WHERE  visibility = 'Show' $qry_string
        ORDER BY vrvInventory.stockNum";
	...
	<div class="full-width page-head color-secondary-orange-dk-2">
		<div class="row">
			<div class="twelve columns">
					<h3>Missing inventory images</h3>
			</div>
		</div>
	</div>
	...
	<div class="full-width page-head color-secondary-yellow-lt-2">
		<div class="row">
			<div class="two columns" style="text-align: center;" >
					<a href="rv-inventory-missing-pics.php?location=North&condition=both">North</a>
			</div>
			<div class="two columns" style="text-align: center;">
					<a href="rv-inventory-missing-pics.php?location=North&condition=new">North New</a>
			</div>
			<div class="two columns" style="text-align: center;">
					<a href="rv-inventory-missing-pics.php?location=North&condition=pre owned">North Pre Owned</a>
			</div>
			<div class="two columns" style="text-align: center;">
					<a href="rv-inventory-missing-pics.php?location=South&condition=both">South</a>
			</div>
			<div class="two columns" style="text-align: center;">
					<a href="rv-inventory-missing-pics.php?location=South&condition=new">South New</a>
			</div>
			<div class="two columns" style="text-align: center;">
					<a href="rv-inventory-missing-pics.php?location=South&condition=pre owned">South Pre Owned</a>
			</div>
		</div>
	</div>
		    	...
		    	<table class="striped">
		    		...
		    		<tbody>
		    			...
		    			<tr>
		    				...
		    				<td><?php echo $row['unit_condition']; ?></td>
		    			</tr>
