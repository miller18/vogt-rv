<?php 
    ...
    $getTotal = "SELECT COUNT(*) FROM vrvInventory WHERE  visibility = 'Show' AND clearance = 'Yes' $search_stmt";
    ...
    $sql = "SELECT 
        ...
        WHERE  visibility = 'Show' AND clearance = 'Yes' $search_stmt
...
<body>
	...
	<div class="full-width  color-secondary-yellow-lt-2">
		<div class="row">
			<div class="twelve columns text-centered">
					<h5>Vogt RV's Spring Cleaning Sale is going on now!</h5>
