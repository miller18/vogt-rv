	...
	<div class="full-width page-head color-secondary-orange-dk-2">
		<div class="row">
				<div class="twelve columns">
					...
					<?php } else { ?>
						<h3>There was  problem with your transaction.</h3>
					<?php } ?>
				</div>
			</div>
		</div>
	   		...
	   		<div class="row">
	        	<div class="twelve columns page-content">
	        		...
	        		<?php if ($_GET['response_code'] == 1){ ?>
						...
						<p>The charge will appear as Hart and Vogt Inc as the merchant on your statement.</p>
						<p>Your transaction id: <?php echo $_GET['transaction_id']; ?></p>
						<p>A copy of your receipt has been emailed to: <?php echo $_GET['email']; ?></p>
						<button>Home</button>
					<?php } else { ?>
						<p>Sorry, an error occurred: <?php echo $_GET['response_reason_text']; ?></p>
						<button> Back </button>
					<?php } ?>
