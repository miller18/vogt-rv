...
<body>
	...
	<div class="row">
		...
		<div class="nine columns">
					...
					-->
						...
						<figure>
							...
							<!-- <figcaption>
								...
								<a class="small-btn" href="rv-inventory-rv-show.php?location=South">See Our RV Specials</a>
							</figcaption> -->
						</figure>
					</li>
			...
			<div class="row">
				<h3 class="white-text color-secondary-orange-dk-2 text-centered rounded">Featured Specials</h3>
			</div>
